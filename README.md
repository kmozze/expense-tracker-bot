...
- Добавление расхода:
  ...
  5. получить подтверждение сохранения с выбранной датой расхода.
- Inline-карточка расхода редактируется на шагах выбора категории, выбора даты, ручного ввода даты и финального подтверждения, чтобы не создавать несколько сообщений одного сценария.
