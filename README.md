...
Telegram-бот для учета личных расходов. Пользователь вводит сумму, при желании добавляет описание, выбирает категорию inline-кнопкой, а бот сохраняет расход в PostgreSQL с текущей датой добавления как датой расхода.
...
- Добавление расхода:
  ...
  3. выбрать категорию;
  4. получить подтверждение сохранения с текущей датой добавления как датой расхода.
